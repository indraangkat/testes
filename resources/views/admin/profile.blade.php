...
<div class="row ">
	<div class="col-lg-5 mt-5">
        <strong>{{ __('Pengaturan Umum') }}</strong>
    </div>
        ...
        <form class="ajaxform" action="{{ route('admin.profile.update','general') }}" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="from-group row">
                    <label class="col-lg-12">{{ __('Nama') }}</label>
                    <div class="col-lg-12">
                ...
                <!-- <div class="from-group row mt-2">
                    <label class="col-lg-12">{{ __('Photo') }}</label>
                    <div class="col-lg-12">
                 ...
                 <div class="from-group row mt-3">
                    <div class="col-lg-12">
                       <button class="btn btn-primary submit-button btn-sm float-left">{{ __('Update') }}</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="from-group row mt-2">
                 ...
                 <div class="from-group row mt-3">
                    <div class="col-lg-12">
                       <button class="btn btn-primary submit-button btn-sm float-left">{{ __('Update Password') }}</button>
                    </div>
                </div>
            </div>
        </div>
