            ...
            <div class="row">
               <div class="col-xxl-12">
                  <div class="breadcrumb__content text-center">
                     <h3 class="breadcrumb__title">{{ __('WELCOME') }}</h3>
                  ...
                  <div class="tp-login-wrapper login-space d-flex justify-content-center">
                     <div id="login" class="tplogin">
                        <div class="tplogin__title">
                           <h3 class="tp-login-title">{{ __('Masuk ke Akun') }}</h3>
                        </div>
                          ...
                          <form method="POST" action="{{ route('login') }}">
                            @csrf
                              ...
                              <div class="tp-login-button">
                                 <button class="tp-btn-blue-square w-100" type="submit"><span>{{ __('Masuk') }}</span></button>
                              </div>
                              <div class="tp-signup d-flex justify-content-between">
                                 <div class="account">
                                    <a href="{{ url('/register') }}">{{ __('Tidak punya akun?') }}</a>
                                 </div>
                                 <div class="signin">
                                    <a href="{{ url('/register') }}">{{ __('Daftar Sekarang') }}</a>
                                 </div>
                              </div>
                           </form>
                        </div>
