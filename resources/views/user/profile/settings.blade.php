...
<div class="row ">
    ...
    <div class="col-lg-7 mt-5">
        <form class="ajaxform" action="{{ route('user.profile.update','general') }}" enctype="multipart/form-data">
        	@csrf
        	@method('PUT')
        	<div class="card">
            <div class="card-body">
...
<div class="row ">
    ...
    <div class="col-lg-7">
    	<form class="ajaxform_reset_form" action="{{ route('user.profile.update','password') }}">
    		@csrf
    		@method('PUT')
        <div class="card">
            <div class="card-body">
